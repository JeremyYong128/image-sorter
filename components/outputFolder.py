...
class OutputFolder(QFrame):
    def __init__(self, name: str, fileService: FileService, parent: QWidget):
        ...
        self.upButton.setIcon(QIcon(os.path.join(self.baseDir, "assets", "up_icon.svg")))
        ...
        self.downButton.setIcon(QIcon(os.path.join(self.baseDir, "assets", "down_icon.svg")))
        ...
        self.deleteButton.setIcon(QIcon(os.path.join(self.baseDir, "assets", "delete_icon.svg")))
